...
vlesslink2="vless://${uuid}@${sts}${domain}:$none?path=${patchvless}&security=none&encryption=none&host=${domain}&type=ws#${user}"
...
vlesslink1="vless://${uuid}@${sts}:$tls?path=wss%3A%2F%2F${stn}${patchvless}&security=tls&encryption=none&host=${domain}&type=ws&sni=$stn#${user}"
vlesslink2="vless://${uuid}@${sts}:$none?path=wss%3A%2F%2F${stn}${patchvless}&security=none&encryption=none&host=${domain}&type=ws#${user}"
systemctl restart xray
clear
echo -e "\e[$line═════[ACC XRAY VMESS & VLESS WEBSOCKET]══════\e[m"
echo -e "Remarks        : ${user}"
...
vlesslink1="vless://${uuid}@${sts}:$tls?path=%2F${patchvless}&security=tls&encryption=none&host=${domain}&type=ws&sni=${domain}#${user}"
vlesslink2="vless://${uuid}@${sts}:$none?path=%2F${patchvless}&security=none&encryption=none&host=${domain}&type=ws#${user}"
systemctl restart xray
clear
echo -e "\e[$line═════[ACC XRAY VMESS & VLESS WEBSOCKET]══════\e[m"
echo -e "Remarks        : ${user}"
